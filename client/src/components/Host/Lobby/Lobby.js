  ...
  render() {
    ...
    return (
      <div className={ styles.main }>
        ...
        <div>
          <audio ref="audio_tag" src={ theme } muted={ this.state.muted }/>
        </div>
        <Grid
          container
          direction="column"
        >
          ...
          >
            <div className={ styles.title }>
              <div className={ styles.join }><span>Join at <strong></strong></span></div>
          ...
          >
            ...
            >
              <h1 className={ styles.logo }>LITTLE UMMAH</h1>
            </Grid>
            <Grid
              item
              xs={4}
