...
const io = socketIO(server, {
  pingTimeout: 60000,
  allowEIO3: true // or false, depending on your requirement
});
...
// let whitelist = ['*', 'http://localhost:3001', 'https://littleummahserver.vercel.app/']
// var corsOptions = {
    ...
    Promise.all([
      ...
      for (let i = 0; i < players.length; i++) {
        const temp = {
          ...
          totalWrong: players[i].totalWrong
        }
        playerScores.push(temp);
      }
